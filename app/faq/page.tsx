...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'We include tools based on relevance, usefulness, category fit, visibility in the market, and their potential value for users looking for AI solutions.',
      },
      {
        question: 'Are the reviews on ailiq unbiased?',
        answer:
          'We aim to present information clearly and fairly. Our goal is to help users understand tools better, compare options more easily, and visit official websites for the most accurate and up-to-date details.',
      },
      {
        question: 'How often is the directory updated?',
        answer:
          'We update content regularly, but AI tools change quickly. Features, pricing, and availability may change over time, so users should always verify important details on the official website.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          'You can browse categories, use search features if available, and explore tools by use case, category, or function depending on the page structure.',
      },
      {
        question: 'What do the different price categories mean?',
        answer:
          'Free means a tool can be used at no cost. Freemium means a free version or limited tier is available with paid upgrades. Paid means a subscription or one-time payment is required. Some tools may also use custom or contact-based pricing.',
      },
      {
        question: 'How are tool ratings calculated?',
        answer:
          'If ratings are shown on a page, they are intended to reflect an overall editorial assessment based on the information available at the time of publication or update.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'If you would like to suggest a tool, request an update, or report outdated information, please contact us through the Contact page.',
      },
      {
        question: 'Do you offer sponsored listings?',
        answer:
          'Any future paid placements or sponsored content would need to be clearly disclosed. Users should rely on the information shown on the page and official product websites for final decisions.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'No account is required to browse the directory or read content unless a future feature specifically requires one.',
      },
      {
